...
from fastapi_solution.src.etl.data_structures.indices import movies_index, genres_index, persons_index
from fastapi_solution.src.etl.data_structures.sql_queries import movies_sql_query, genres_sql_query, persons_sql_query
